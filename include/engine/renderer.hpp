...
namespace zuul
{
    ...
    public:
        ...
        virtual void renderTextureWithShader(std::shared_ptr<Texture> texture, int srcX, int srcY, int srcW, int srcH,
                                    int destX, int destY, int destW, int destH, const std::string& shaderName) = 0;
