...
namespace zuul
{
    ...
    public:
        ...
        void renderTextureWithShader(const std::shared_ptr<Texture> &texture, int srcX, int srcY, int srcW, int srcH,
                                    int destX, int destY, int destW, int destH, const std::string& shaderName) override;
